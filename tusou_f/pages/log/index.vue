<template>
    <div class="log">
        <div class="log_box">
            <el-form :model="logForm" status-icon :rules="logRules" ref="logForm" label-width="70px" size="small" class="log_form">
                <el-form-item label="昵称" prop="nickName">
                    <el-input type="text" v-model="logForm.nickName" auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item label="密码" prop="pass">
                    <el-input type="password" v-model="logForm.pass" auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item>
